...
%                    coordinates in x, y, and z dimensions, respectively.
    ...
    kx_te1 = kx_te1(1+traj.skip_start_te1 : end-traj.skip_end_te1, :, :);
    ky_te1 = ky_te1(1+traj.skip_start_te1 : end-traj.skip_end_te1, :, :);
    kz_te1 = kz_te1(1+traj.skip_start_te1 : end-traj.skip_end_te1, :, :);
    kx_te2 = kx_te2(1+traj.skip_start_te2 : end-traj.skip_end_te2, :, :);
    ky_te2 = ky_te2(1+traj.skip_start_te2 : end-traj.skip_end_te2, :, :);
    kz_te2 = kz_te2(1+traj.skip_start_te2 : end-traj.skip_end_te2, :, :);
