function [fit_result, rmse, AIC, TEfit, Sfit, Sfit_TE] = UTE_T1T2_model_fit(TE_all,S_all,flips, TR, fit_params, general_opts)
    ...
    function x_out = generate_x_scan(x_in, Iscan)
        ...
        for m = 1:general_opts.num_components
            ...
            x_out = [x_out, x_in(1 + component_offset),  x_in(2 + component_offset ) ...
                x_in(3 + component_offset ) x_in(3+Iscan + component_offset) x_in(1*num_scans+4 + component_offset)];
        end
    end
