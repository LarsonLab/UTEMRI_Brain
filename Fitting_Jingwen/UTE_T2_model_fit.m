function [fit_result, rmse, AIC, TEfit, Sfit, Sfit_TE] = UTE_T2_model_fit(TE_all,S_all,fit_params, general_opts)
...
for n = 1:general_opts.num_components
    ...
    function res = model_diff(x)
        ...
        for n = 1:num_scans
            ...
            if 0 % general_opts.use_weights == 1
...
for n =1:num_scans
    ...
    Sfit_TE{n} = utebrain_signal_model(X_scan, general_opts.num_components, TE_all{n})*Snorm;
end
