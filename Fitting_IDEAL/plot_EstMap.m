...
subplot(242)
imagesc(EstMap.Rho2_map,[0 10]); axis off; axis tight; axis equal; title('Rho2'); colorbar;
subplot(243)
imagesc(EstMap.RhoF_map,[0 0.5]); axis off; axis tight; axis equal; title('Rho fraction'); colorbar;
subplot(244)
imagesc(EstMap.Phi_map,[-100 100]); axis off; axis tight; axis equal; title('delta B0'); colorbar;
...
subplot(141)
imagesc(EstMap.Rmse_map,[0 0.02]); axis off; axis tight; axis equal;
subplot(142)
imagesc(EstMap.Iter_map,[0 100]); axis off; axis tight; axis equal;
